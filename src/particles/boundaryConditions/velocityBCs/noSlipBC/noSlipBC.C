...
{
    defineTypeNameAndDebug(noSlipBC, 0);
...
Foam::velocityBCs::noSlipBC::noSlipBC
(
...
Foam::velocityBCs::noSlipBC::noSlipBC(const velocityBC& bc)
:
    velocityBC(bc)
{}
...
void Foam::velocityBCs::noSlipBC::forcingOnFluid
(
    const scalar& dT,
    const vectorList& U,
