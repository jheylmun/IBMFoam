...
const std::size_t Foam::anisothermalParticleIBM<pType>::sizeofFields_
(
    sizeof(anisothermalParticleIBM)
);
...
void Foam::anisothermalParticleIBM<pType>::writeFields
(
...
)
{
    ...
    forAllConstIter(typename Cloud<anisothermalParticleIBM<pType>>, c, iter)
    {
        T[i] = pIter().T();
        i++;
    }
...
void Foam::anisothermalParticleIBM<pType>::readFields
(
...
)
{
    ...
    label i = 0;
    forAllIter(typename Cloud<anisothermalParticleIBM<pType>>, c, iter)
    {
        pIter().T_ = T[i];
        i++;
    }
...
)
{
    ...
    else
    {
        ...
        (
            ...
            anisothermalParticleIBM<pType>::sizeofFields_
        );
    }
